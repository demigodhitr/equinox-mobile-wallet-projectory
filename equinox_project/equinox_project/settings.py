...
AUTH_USER_MODEL = 'equinox.CustomUser'
...
SECRET_KEY = 'django-insecure-$w)z8jdfey*13gm9ebjol8aky+c+mxm44n$ndzs1fex@+m$1)#'
...
ROOT_URLCONF = 'equinox_project.urls'
...
WSGI_APPLICATION = 'equinox_project.wsgi.application'
